                    ...
                    <form action="<?= base_url('onLogin') ?>" method="post">
                        <div class="card-body px-5 pb-5">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    <input type="text" name="password" class="form-control border-0 border-top border-start border-bottom" placeholder="Isi password dengan benar" aria-label="Isi password dengan benar" aria-describedby="addon-wrapping">
                                    <span class="input-group-text bg-white border-0 border-top border-end border-bottom" id="addon-wrapping">
